"""
Django settings for nb_test_app_45182 project.
...
ROOT_URLCONF = 'nb_test_app_45182.urls'
...
WSGI_APPLICATION = 'nb_test_app_45182.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nb_test_app_45182 API",
    "DESCRIPTION": "API documentation for nb_test_app_45182 App",
    "VERSION": "v1",
}
